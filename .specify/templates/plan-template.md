...
- [ ] Design includes modern, professional UI components (Radix UI + Tailwind)
- [ ] All UI states clearly defined (loading, success, error)
- [ ] Responsive design verified across device sizes
- [ ] No development artifacts in user-facing code

### II. Integration Dependency Constraint
- [ ] All chains used are supported by BOTH Odos AND CCTP v2
- [ ] Chain compatibility verified before implementation
- [ ] Current supported: Ethereum, Arbitrum, Optimism, Base, Polygon, Unichain, Avalanche, Linea

### III. User Safety First
- [ ] Transaction previews show all fees, slippage, amounts
- [ ] Error messages are actionable and user-friendly
- [ ] No auto-execution without explicit confirmation
- [ ] Wallet states clearly communicated

### IV. Performance & Reliability
- [ ] Loading states for all async operations
- [ ] Timeout and retry mechanisms planned
- [ ] Gas estimation with safety buffer
- [ ] Graceful error handling defined

### V. Type Safety & Testing
- [ ] TypeScript strict mode enforced
- [ ] No `any` types (except unavoidable third-party cases)
